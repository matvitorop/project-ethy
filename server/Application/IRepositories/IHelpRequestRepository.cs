...
namespace server.Application.IRepositories
{
    public interface IHelpRequestRepository
    {
        ...
        Task<IReadOnlyList<HelpRequestListItemDto>> GetPageAsync(CancellationToken ct, int page, int pageSize, HelpRequestStatus? status = null, IReadOnlyList<HelpRequestStatus>? statuses = null, Guid? creatorId = null, Guid? assignedUserId = null, bool? hasNoReport = null);
