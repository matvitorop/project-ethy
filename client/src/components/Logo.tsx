    ...
    return (
        <div className="flex items-center gap-3">
            <svg width={size} height={size} viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
                {/* Темні елементи — адаптуються через currentColor */}
                <rect x="35" y="40" width="70" height="220" rx="5" className="fill-primary" />
                <rect x="105" y="182" width="65" height="90" transform="rotate(-90 105 182)" className="fill-primary" />
                <rect x="195" y="40" width="70" height="220" rx="5" className="fill-primary" />
                {/* Жовті елементи — залишаються жовтими в обох темах */}
